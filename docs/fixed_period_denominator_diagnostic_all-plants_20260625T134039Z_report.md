...
Generated UTC: 2026-06-25T13:40:40+00:00

## Run

- Diagnostic run ID: `fixed_period_denominator_diagnostic_all-plants_20260625T134039Z`
...
- Detail CSV: `fixed_period_denominator_diagnostic_all-plants_20260625T134039Z.csv`

## Summary

| Metric | Count |
| --- | ---: |
| Blocked plant rows in scope | 14,491 |
| Active-window coverage pass, any candidate | 14,463 |
| Active-window coverage plus 20 loaded fixed years pass, any candidate | 9,915 |
| Active-window coverage plus active-loaded-year-ratio pass, any candidate | 14,463 |
| Normalized active-window coverage pass, any candidate | 14,448 |
| Normalized active-window coverage plus 20 loaded fixed years pass, any candidate | 4,485 |
| Normalized active-window coverage plus active-loaded-year-ratio pass, any candidate | 14,448 |
| Best active-window candidate has valid hours beyond active expected hours | 10,364 |
| Best active-window coverage ratio > 1.00 | 10,364 |
...
| Class | Rows |
| --- | --- |
| fixed_coverage_below_threshold | 14,463 |
...
| Class | Rows |
| --- | --- |
| would_pass_active_window_coverage_and_active_year_ratio | 14,463 |
| no_station_candidates | 28 |
...
| Class | Rows |
| --- | --- |
| would_pass_normalized_active_window_coverage_and_active_year_ratio | 14,448 |
| no_station_candidates | 28 |
