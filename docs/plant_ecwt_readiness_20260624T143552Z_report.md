...
Generated UTC: 2026-06-24T14:35:54+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T143552Z`
...
| `publication candidates` | 958 |
| `provisional low coverage` | 15146 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13777 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1369 |
| `publication_candidate` | `passes_current_publication_gate` | 958 |
