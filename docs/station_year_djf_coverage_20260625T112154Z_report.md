...
Generated UTC: 2026-06-25T11:22:01+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T112154Z`
...
| --- | ---: |
| `coverage rows for this run` | 69800 |
| `complete station-years` | 17830 |
| `partial station-years` | 49289 |
| `empty station-years` | 2681 |
| `valid DJF hours represented` | 61633010 |
| `rejected source rows represented` | 143139047 |
