...
Generated UTC: 2026-06-24T15:05:52+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T150549Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T150405Z`
...
| `publication candidates` | 1463 |
| `provisional low coverage` | 14641 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.2390 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13272 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1369 |
| `publication_candidate` | `passes_current_publication_gate` | 1463 |
