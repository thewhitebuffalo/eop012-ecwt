...
| `publication candidates` | 44 |
| `provisional low coverage` | 16060 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 8859 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 7201 |
| `publication_candidate` | `passes_current_publication_gate` | 44 |
