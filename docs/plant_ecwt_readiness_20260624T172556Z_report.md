...
Generated UTC: 2026-06-24T17:25:58+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T172556Z`
...
| `publication candidates` | 7747 |
| `provisional low coverage` | 8357 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 7057 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1300 |
| `publication_candidate` | `passes_current_publication_gate` | 7747 |
