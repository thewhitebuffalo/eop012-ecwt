...
Generated UTC: 2026-06-24T06:05:46+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T060231Z`
...
| --- | ---: |
| `coverage rows for this run` | 32037 |
| `complete station-years` | 4776 |
| `partial station-years` | 26527 |
| `empty station-years` | 734 |
| `valid DJF hours represented` | 19998652 |
| `rejected source rows represented` | 85979131 |
