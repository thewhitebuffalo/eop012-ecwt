...
Generated UTC: 2026-06-24T18:26:44+00:00
...
- Calculation run ID: `noaa_backfill_download_batch75_20260624T182643Z`
...
| `audit.calculation_run` | 396 |

## Missing On AWS Sample

| Status | HTTP | Station | Year | URL | Error |
| --- | ---: | --- | ---: | --- | --- |
| `missing_on_aws` | 404 | `999999-12989` | 2016 | `https://noaa-global-hourly-pds.s3.amazonaws.com/2016/99999912989.csv` | HTTP Error 404: Not Found |
