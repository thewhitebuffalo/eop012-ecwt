...
Generated UTC: 2026-06-24T07:19:52+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T071951Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T071911Z`
...
| `publication candidates` | 2740 |
| `provisional low coverage` | 13364 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.0800 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9615 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 3749 |
| `publication_candidate` | `passes_current_publication_gate` | 2740 |
