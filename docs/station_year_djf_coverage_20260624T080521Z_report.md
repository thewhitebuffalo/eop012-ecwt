...
Generated UTC: 2026-06-24T08:08:50+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T080521Z`
...
| --- | ---: |
| `coverage rows for this run` | 39682 |
| `complete station-years` | 6305 |
| `partial station-years` | 32474 |
| `empty station-years` | 903 |
| `valid DJF hours represented` | 25588625 |
| `rejected source rows represented` | 106218568 |
