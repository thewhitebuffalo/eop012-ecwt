...
Generated UTC: 2026-06-24T11:22:39+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T111840Z`
...
| --- | ---: |
| `coverage rows for this run` | 48241 |
| `complete station-years` | 8877 |
| `partial station-years` | 38231 |
| `empty station-years` | 1133 |
| `valid DJF hours represented` | 33482494 |
