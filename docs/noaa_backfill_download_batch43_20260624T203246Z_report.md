...
Generated UTC: 2026-06-24T20:32:47+00:00
...
- Calculation run ID: `noaa_backfill_download_batch43_20260624T203246Z`
...
| `audit.calculation_run` | 430 |

## Missing On AWS Sample

| Status | HTTP | Station | Year | URL | Error |
| --- | ---: | --- | ---: | --- | --- |
| `missing_on_aws` | 404 | `725377-14804` | 2003 | `https://noaa-global-hourly-pds.s3.amazonaws.com/2003/72537714804.csv` | HTTP Error 404: Not Found |
