...
Generated UTC: 2026-06-24T00:54:58+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T005455Z`
...
| `publication candidates` | 203 |
| `provisional low coverage` | 15901 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14314 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1587 |
| `publication_candidate` | `passes_current_publication_gate` | 203 |
