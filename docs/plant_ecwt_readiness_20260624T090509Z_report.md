...
Generated UTC: 2026-06-24T09:05:13+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T090509Z`
...
| `publication candidates` | 124 |
| `provisional low coverage` | 15980 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14090 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1890 |
| `publication_candidate` | `passes_current_publication_gate` | 124 |
