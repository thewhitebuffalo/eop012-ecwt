...
Generated UTC: 2026-06-24T12:01:46+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T120143Z`
...
| `publication candidates` | 745 |
| `provisional low coverage` | 15359 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13894 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1465 |
| `publication_candidate` | `passes_current_publication_gate` | 745 |
