...
Generated UTC: 2026-06-24T11:04:33+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T110431Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T110204Z`
...
| `publication candidates` | 4989 |
| `provisional low coverage` | 11115 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.1573 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9594 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1521 |
| `publication_candidate` | `passes_current_publication_gate` | 4989 |
