...
Generated UTC: 2026-06-24T14:36:04+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T143603Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T143507Z`
...
| `publication candidates` | 7212 |
| `provisional low coverage` | 8892 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.2129 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 7523 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1369 |
| `publication_candidate` | `passes_current_publication_gate` | 7212 |
