...
Generated UTC: 2026-06-24T08:43:00+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T084258Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T084134Z`
...
| `publication candidates` | 3289 |
| `provisional low coverage` | 12815 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.0970 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 10773 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 2042 |
| `publication_candidate` | `passes_current_publication_gate` | 3289 |
