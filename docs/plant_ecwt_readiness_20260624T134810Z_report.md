...
Generated UTC: 2026-06-24T13:48:22+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T134810Z`
...
| `publication candidates` | 903 |
| `provisional low coverage` | 15201 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13848 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1353 |
| `publication_candidate` | `passes_current_publication_gate` | 903 |
