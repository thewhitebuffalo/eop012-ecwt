...
Generated UTC: 2026-06-25T11:59:30+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T115920Z`
...
| --- | ---: |
| `coverage rows for this run` | 72259 |
| `complete station-years` | 18653 |
| `partial station-years` | 50803 |
| `empty station-years` | 2803 |
| `valid DJF hours represented` | 64702616 |
