...
Generated UTC: 2026-06-24T02:48:30+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T024829Z`
...
| `publication candidates` | 13518 |
| `provisional low coverage` | 2586 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 1938 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 648 |
| `publication_candidate` | `passes_current_publication_gate` | 13518 |
