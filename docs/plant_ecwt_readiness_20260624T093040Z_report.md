...
Generated UTC: 2026-06-24T09:30:42+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T093040Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T092912Z`
...
| `publication candidates` | 4250 |
| `provisional low coverage` | 11854 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.1093 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 10099 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1755 |
| `publication_candidate` | `passes_current_publication_gate` | 4250 |
