...
Generated UTC: 2026-06-24T08:12:50+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T081248Z`
...
| `publication candidates` | 3071 |
| `provisional low coverage` | 13033 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 10750 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 2283 |
| `publication_candidate` | `passes_current_publication_gate` | 3071 |
