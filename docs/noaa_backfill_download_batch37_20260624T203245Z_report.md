...
Generated UTC: 2026-06-24T20:32:46+00:00
...
- Calculation run ID: `noaa_backfill_download_batch37_20260624T203245Z`
...
| `audit.calculation_run` | 429 |

## Missing On AWS Sample

| Status | HTTP | Station | Year | URL | Error |
| --- | ---: | --- | ---: | --- | --- |
| `missing_on_aws` | 404 | `723629-99999` | 2004 | `https://noaa-global-hourly-pds.s3.amazonaws.com/2004/72362999999.csv` | HTTP Error 404: Not Found |
