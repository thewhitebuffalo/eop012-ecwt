...
Generated UTC: 2026-06-25T10:45:54+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T104547Z`
...
| --- | ---: |
| `coverage rows for this run` | 67103 |
| `complete station-years` | 16413 |
| `partial station-years` | 48134 |
| `empty station-years` | 2556 |
| `valid DJF hours represented` | 57629506 |
| `rejected source rows represented` | 142748199 |
