...
Generated UTC: 2026-06-24T10:40:31+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T104030Z`
...
| `publication candidates` | 4608 |
| `provisional low coverage` | 11496 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9903 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1593 |
| `publication_candidate` | `passes_current_publication_gate` | 4608 |
