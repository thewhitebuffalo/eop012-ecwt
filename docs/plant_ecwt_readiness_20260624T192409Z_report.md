...
Generated UTC: 2026-06-24T19:24:13+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T192409Z`
...
| `publication candidates` | 1666 |
| `provisional low coverage` | 14438 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13149 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1289 |
| `publication_candidate` | `passes_current_publication_gate` | 1666 |
