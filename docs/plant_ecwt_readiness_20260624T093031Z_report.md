...
Generated UTC: 2026-06-24T09:30:35+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T093031Z`
...
| `publication candidates` | 139 |
| `provisional low coverage` | 15965 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14210 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1755 |
| `publication_candidate` | `passes_current_publication_gate` | 139 |
