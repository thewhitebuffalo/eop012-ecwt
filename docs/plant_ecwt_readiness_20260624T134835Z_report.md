...
Generated UTC: 2026-06-24T13:48:37+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T134835Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T134639Z`
...
| `publication candidates` | 7198 |
| `provisional low coverage` | 8906 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.2026 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 7553 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1353 |
| `publication_candidate` | `passes_current_publication_gate` | 7198 |
