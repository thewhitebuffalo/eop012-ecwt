...
Generated UTC: 2026-06-24T15:38:13+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T153809Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T153607Z`
...
| `publication candidates` | 1658 |
| `provisional low coverage` | 14446 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.2434 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13080 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1366 |
| `publication_candidate` | `passes_current_publication_gate` | 1658 |
