...
Generated UTC: 2026-06-24T03:52:20+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T035218Z`
...
| `publication candidates` | 2494 |
| `provisional low coverage` | 13610 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13266 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 344 |
| `publication_candidate` | `passes_current_publication_gate` | 2494 |
