...
Generated UTC: 2026-06-24T09:54:37+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T095435Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T095247Z`
...
| `publication candidates` | 4492 |
| `provisional low coverage` | 11612 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.1275 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9847 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1765 |
| `publication_candidate` | `passes_current_publication_gate` | 4492 |
