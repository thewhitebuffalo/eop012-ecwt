...
Generated UTC: 2026-06-24T09:05:23+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T090522Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T090344Z`
...
| `publication candidates` | 3719 |
| `provisional low coverage` | 12385 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.0992 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 10495 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1890 |
| `publication_candidate` | `passes_current_publication_gate` | 3719 |
