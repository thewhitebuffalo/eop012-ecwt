...
Generated UTC: 2026-06-25T11:11:10+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T111104Z`
...
| --- | ---: |
| `coverage rows for this run` | 68949 |
| `complete station-years` | 17384 |
| `partial station-years` | 48910 |
| `empty station-years` | 2655 |
| `valid DJF hours represented` | 60370228 |
| `rejected source rows represented` | 143001809 |
