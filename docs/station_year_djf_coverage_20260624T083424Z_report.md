...
Generated UTC: 2026-06-24T08:38:46+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T083424Z`
...
| --- | ---: |
| `coverage rows for this run` | 41099 |
| `complete station-years` | 6474 |
| `partial station-years` | 33715 |
| `empty station-years` | 910 |
| `valid DJF hours represented` | 26239542 |
| `rejected source rows represented` | 110564242 |
