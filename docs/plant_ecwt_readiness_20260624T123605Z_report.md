...
Generated UTC: 2026-06-24T12:36:08+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T123605Z`
...
| `publication candidates` | 760 |
| `provisional low coverage` | 15344 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13819 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1525 |
| `publication_candidate` | `passes_current_publication_gate` | 760 |
