...
Generated UTC: 2026-06-24T20:32:36+00:00
...
- Calculation run ID: `noaa_backfill_download_batch23_20260624T203233Z`
...
| --- | ---: |
| `downloaded` | 1 |
| `total_bytes_downloaded_or_observed` | 7703681 |
...
| `failed_http` | 0 |
| `failed_exception` | 0 |
| `downloaded bytes` | 7703681 |
| `remaining planned rows in batch` | 0 |
| `audit.source_file` | 34764 |
| `audit.calculation_run` | 424 |
