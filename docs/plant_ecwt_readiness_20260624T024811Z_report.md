...
Generated UTC: 2026-06-24T02:48:13+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T024811Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T024724Z`
...
| `publication candidates` | 2485 |
| `provisional low coverage` | 13619 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0472 |
| `median coverage ratio` | 0.8415 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 12971 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 648 |
| `publication_candidate` | `passes_current_publication_gate` | 2485 |
