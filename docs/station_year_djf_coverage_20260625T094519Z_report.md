...
Generated UTC: 2026-06-25T09:45:28+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T094519Z`
...
| --- | ---: |
| `coverage rows for this run` | 65257 |
| `complete station-years` | 15335 |
| `partial station-years` | 47431 |
| `empty station-years` | 2491 |
| `valid DJF hours represented` | 54700292 |
| `rejected source rows represented` | 142291571 |
