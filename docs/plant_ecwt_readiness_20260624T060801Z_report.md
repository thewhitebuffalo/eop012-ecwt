...
Generated UTC: 2026-06-24T06:08:08+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T060801Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T060727Z`
...
| `publication candidates` | 2374 |
| `provisional low coverage` | 13730 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.0563 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 7877 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 5853 |
| `publication_candidate` | `passes_current_publication_gate` | 2374 |
