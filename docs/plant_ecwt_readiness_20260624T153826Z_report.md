...
Generated UTC: 2026-06-24T15:38:28+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T153826Z`
...
| `publication candidates` | 7647 |
| `provisional low coverage` | 8457 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 7091 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1366 |
| `publication_candidate` | `passes_current_publication_gate` | 7647 |
