...
Generated UTC: 2026-06-24T14:30:40+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T141927Z`
...
| --- | ---: |
| `coverage rows for this run` | 52558 |
| `complete station-years` | 11005 |
| `partial station-years` | 39764 |
| `empty station-years` | 1789 |
| `valid DJF hours represented` | 39950790 |
| `rejected source rows represented` | 122694097 |
