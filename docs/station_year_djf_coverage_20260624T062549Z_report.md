...
Generated UTC: 2026-06-24T06:30:02+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T062549Z`
...
| --- | ---: |
| `coverage rows for this run` | 33579 |
| `complete station-years` | 4952 |
| `partial station-years` | 27868 |
| `empty station-years` | 759 |
| `valid DJF hours represented` | 20719284 |
| `rejected source rows represented` | 91258353 |
