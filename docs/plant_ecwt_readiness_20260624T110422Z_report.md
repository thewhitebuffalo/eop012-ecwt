...
Generated UTC: 2026-06-24T11:04:26+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T110422Z`
...
| `publication candidates` | 525 |
| `provisional low coverage` | 15579 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14058 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1521 |
| `publication_candidate` | `passes_current_publication_gate` | 525 |
