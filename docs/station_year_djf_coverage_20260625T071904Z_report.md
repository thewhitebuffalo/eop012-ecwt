...
Generated UTC: 2026-06-25T07:32:42+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T071904Z`
...
| --- | ---: |
| `coverage rows for this run` | 63312 |
| `complete station-years` | 14479 |
| `partial station-years` | 46425 |
| `empty station-years` | 2408 |
| `valid DJF hours represented` | 51702398 |
| `rejected source rows represented` | 141769072 |
