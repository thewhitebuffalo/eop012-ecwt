...
Generated UTC: 2026-06-24T14:58:59+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T145255Z`
...
| --- | ---: |
| `coverage rows for this run` | 53328 |
| `complete station-years` | 11415 |
| `partial station-years` | 40017 |
| `empty station-years` | 1896 |
| `valid DJF hours represented` | 41133536 |
