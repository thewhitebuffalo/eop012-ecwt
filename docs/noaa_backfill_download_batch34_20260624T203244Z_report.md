...
Generated UTC: 2026-06-24T20:32:45+00:00
...
- Calculation run ID: `noaa_backfill_download_batch34_20260624T203244Z`
...
| `audit.calculation_run` | 428 |

## Missing On AWS Sample

| Status | HTTP | Station | Year | URL | Error |
| --- | ---: | --- | ---: | --- | --- |
| `missing_on_aws` | 404 | `723759-53990` | 2005 | `https://noaa-global-hourly-pds.s3.amazonaws.com/2005/72375953990.csv` | HTTP Error 404: Not Found |
| `missing_on_aws` | 404 | `724375-03893` | 2005 | `https://noaa-global-hourly-pds.s3.amazonaws.com/2005/72437503893.csv` | HTTP Error 404: Not Found |
