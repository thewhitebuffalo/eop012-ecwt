...
Generated UTC: 2026-06-24T06:53:28+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T065003Z`
...
| --- | ---: |
| `coverage rows for this run` | 35122 |
| `complete station-years` | 5106 |
| `partial station-years` | 29227 |
| `empty station-years` | 789 |
| `valid DJF hours represented` | 21476954 |
| `rejected source rows represented` | 95982832 |
