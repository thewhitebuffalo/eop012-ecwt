...
Generated UTC: 2026-06-24T20:32:33+00:00
...
- Calculation run ID: `noaa_backfill_download_batch8_20260624T203225Z`
...
| --- | ---: |
| `downloaded` | 1 |
| `total_bytes_downloaded_or_observed` | 8807488 |
...
| `failed_http` | 0 |
| `failed_exception` | 0 |
| `downloaded bytes` | 8807488 |
| `remaining planned rows in batch` | 0 |
| `audit.source_file` | 34763 |
| `audit.calculation_run` | 423 |
