...
Generated UTC: 2026-06-24T04:28:37+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T042620Z`
...
| --- | ---: |
| `coverage rows for this run` | 27282 |
| `complete station-years` | 3921 |
| `partial station-years` | 22724 |
| `empty station-years` | 637 |
| `valid DJF hours represented` | 16970313 |
| `rejected source rows represented` | 72539567 |
