...
Generated UTC: 2026-06-24T20:32:43+00:00
...
- Calculation run ID: `noaa_backfill_download_batch28_20260624T203239Z`
...
| --- | ---: |
| `downloaded` | 2 |
| `total_bytes_downloaded_or_observed` | 17029200 |
...
| `failed_http` | 0 |
| `failed_exception` | 0 |
| `downloaded bytes` | 17029200 |
| `remaining planned rows in batch` | 0 |
| `audit.source_file` | 34767 |
| `audit.calculation_run` | 426 |
