...
Generated UTC: 2026-06-24T13:07:58+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T130018Z`
...
| --- | ---: |
| `coverage rows for this run` | 51117 |
| `complete station-years` | 10305 |
| `partial station-years` | 39265 |
| `empty station-years` | 1547 |
| `valid DJF hours represented` | 37858706 |
