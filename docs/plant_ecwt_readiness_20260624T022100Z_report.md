...
Generated UTC: 2026-06-24T02:21:02+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T022100Z`
...
| `publication candidates` | 298 |
| `provisional low coverage` | 15806 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14922 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 884 |
| `publication_candidate` | `passes_current_publication_gate` | 298 |
