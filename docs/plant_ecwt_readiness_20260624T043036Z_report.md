...
Generated UTC: 2026-06-24T04:30:38+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T043036Z`
...
| `publication candidates` | 13345 |
| `provisional low coverage` | 2759 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 2490 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 269 |
| `publication_candidate` | `passes_current_publication_gate` | 13345 |
