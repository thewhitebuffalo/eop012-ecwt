...
Generated UTC: 2026-06-24T01:54:52+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T015450Z`
...
| `publication candidates` | 367 |
| `provisional low coverage` | 15737 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14404 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1333 |
| `publication_candidate` | `passes_current_publication_gate` | 367 |
