...
Generated UTC: 2026-06-24T05:44:39+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T054438Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T052724Z`
- Methodology version: `eop012-ecwt-method-v0.1.0`
- Code commit: `219c91e1d322b73f5426b7366779fba8aaa11c7a`
...
| `publication candidates` | 2294 |
| `provisional low coverage` | 13810 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.0542 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 7463 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 6347 |
| `publication_candidate` | `passes_current_publication_gate` | 2294 |
