...
Generated UTC: 2026-06-24T06:33:20+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T063302Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T063217Z`
...
| `publication candidates` | 2488 |
| `provisional low coverage` | 13616 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.0573 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 8188 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 5428 |
| `publication_candidate` | `passes_current_publication_gate` | 2488 |
