...
Generated UTC: 2026-06-24T05:44:17+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T054410Z`
...
| `publication candidates` | 53 |
| `provisional low coverage` | 16051 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9704 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 6347 |
| `publication_candidate` | `passes_current_publication_gate` | 53 |
