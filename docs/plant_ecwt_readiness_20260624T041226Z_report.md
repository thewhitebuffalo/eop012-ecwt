...
Generated UTC: 2026-06-24T04:12:28+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T041226Z`
...
| `publication candidates` | 2646 |
| `provisional low coverage` | 13458 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13164 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 294 |
| `publication_candidate` | `passes_current_publication_gate` | 2646 |
