...
Generated UTC: 2026-06-24T06:56:33+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T065624Z`
...
| `publication candidates` | 2516 |
| `provisional low coverage` | 13588 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 8565 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 5023 |
| `publication_candidate` | `passes_current_publication_gate` | 2516 |
