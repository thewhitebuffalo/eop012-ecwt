...
Generated UTC: 2026-06-24T09:54:27+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T095424Z`
...
| `publication candidates` | 234 |
| `provisional low coverage` | 15870 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 14105 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1765 |
| `publication_candidate` | `passes_current_publication_gate` | 234 |
