...
Generated UTC: 2026-06-24T04:52:43+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T044835Z`
...
| --- | ---: |
| `coverage rows for this run` | 28858 |
| `complete station-years` | 4384 |
| `partial station-years` | 23781 |
| `empty station-years` | 693 |
| `valid DJF hours represented` | 18362666 |
| `rejected source rows represented` | 75968124 |
