...
Generated UTC: 2026-06-24T00:32:10+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T003209Z`
...
| `publication candidates` | 13384 |
| `provisional low coverage` | 2720 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 938 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1782 |
| `publication_candidate` | `passes_current_publication_gate` | 13384 |
