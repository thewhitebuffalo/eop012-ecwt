...
Generated UTC: 2026-06-24T10:58:31+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T105442Z`
...
| --- | ---: |
| `coverage rows for this run` | 47843 |
| `complete station-years` | 8690 |
| `partial station-years` | 38066 |
| `empty station-years` | 1087 |
| `valid DJF hours represented` | 32894957 |
