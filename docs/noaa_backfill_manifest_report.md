...
Generated UTC: 2026-06-25T15:44:23+00:00
...
- Calculation run ID: `noaa_backfill_manifest_20260625T154422Z`
- Source inventory run ID: `noaa_raw_file_inventory_20260625T153854Z`
...
| Filter Metric | Rows |
| --- | ---: |
| `missing inventory rows` | 59973 |
| `active-window unknown rows` | 0 |
| `DJF active-window eligible rows` | 4281 |
| `DJF active-window excluded rows` | 55692 |
| `known terminal AWS 404 rows` | 45497 |
