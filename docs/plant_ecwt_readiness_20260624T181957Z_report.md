...
Generated UTC: 2026-06-24T18:20:01+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T181957Z`
...
| `publication candidates` | 1673 |
| `provisional low coverage` | 14431 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13139 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1292 |
| `publication_candidate` | `passes_current_publication_gate` | 1673 |
