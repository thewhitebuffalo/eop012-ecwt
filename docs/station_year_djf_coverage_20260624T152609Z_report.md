...
Generated UTC: 2026-06-24T15:32:09+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T152609Z`
...
| --- | ---: |
| `coverage rows for this run` | 54102 |
| `complete station-years` | 11794 |
| `partial station-years` | 40315 |
| `empty station-years` | 1993 |
| `valid DJF hours represented` | 42332554 |
| `rejected source rows represented` | 122786160 |
