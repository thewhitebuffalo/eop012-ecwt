...
Generated UTC: 2026-06-24T20:32:39+00:00
...
- Calculation run ID: `noaa_backfill_download_batch25_20260624T203236Z`
...
| --- | ---: |
| `downloaded` | 1 |
| `total_bytes_downloaded_or_observed` | 7690341 |
...
| `failed_http` | 0 |
| `failed_exception` | 0 |
| `downloaded bytes` | 7690341 |
| `remaining planned rows in batch` | 0 |
| `audit.source_file` | 34765 |
| `audit.calculation_run` | 425 |
