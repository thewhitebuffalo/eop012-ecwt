...
Generated UTC: 2026-06-24T20:20:22+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T200228Z`
...
| --- | ---: |
| `coverage rows for this run` | 62313 |
| `complete station-years` | 14160 |
| `partial station-years` | 45800 |
| `empty station-years` | 2353 |
| `valid DJF hours represented` | 50341330 |
| `rejected source rows represented` | 137963220 |
