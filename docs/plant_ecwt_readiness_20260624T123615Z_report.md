...
Generated UTC: 2026-06-24T12:36:17+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T123615Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T123513Z`
...
| `publication candidates` | 6161 |
| `provisional low coverage` | 9943 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.1810 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 8418 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1525 |
| `publication_candidate` | `passes_current_publication_gate` | 6161 |
