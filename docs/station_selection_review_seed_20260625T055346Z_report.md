...
Generated UTC: 2026-06-25T05:53:51+00:00

## Summary

This run seeded `162` station-selection review rows for fixed-period publication candidates from readiness run `plant_ecwt_readiness_fixed_period_20260625T043609Z`. The seed is intentionally conservative: rows with any QA flag are `needs_review`, and only clean rows can be automatically accepted.
...
- Review run ID: `station_selection_review_seed_20260625T055346Z`
- Readiness run ID: `plant_ecwt_readiness_fixed_period_20260625T043609Z`
- Code commit: `683fea6a5ead106306b10578c639822119461f7d`
- Review CSV: `station_selection_review_seed_20260625T055346Z.csv`
