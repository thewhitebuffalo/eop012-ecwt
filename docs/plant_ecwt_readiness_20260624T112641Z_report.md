...
Generated UTC: 2026-06-24T11:26:44+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T112641Z`
...
| `publication candidates` | 5193 |
| `provisional low coverage` | 10911 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9440 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1471 |
| `publication_candidate` | `passes_current_publication_gate` | 5193 |
