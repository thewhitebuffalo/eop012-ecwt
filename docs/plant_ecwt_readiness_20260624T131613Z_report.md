...
Generated UTC: 2026-06-24T13:16:16+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T131613Z`
- Plant ECWT run ID: `plant_ecwt_provisional_20260624T131445Z`
...
| `publication candidates` | 828 |
| `provisional low coverage` | 15276 |
| `blocked` | 28 |
| `minimum coverage ratio` | 0.0000 |
| `median coverage ratio` | 0.1886 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13898 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1378 |
| `publication_candidate` | `passes_current_publication_gate` | 828 |
