...
Generated UTC: 2026-06-24T04:09:41+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T040547Z`
...
| --- | ---: |
| `coverage rows for this run` | 25702 |
| `complete station-years` | 3753 |
| `partial station-years` | 21337 |
| `empty station-years` | 612 |
| `valid DJF hours represented` | 16270808 |
| `rejected source rows represented` | 67696686 |
