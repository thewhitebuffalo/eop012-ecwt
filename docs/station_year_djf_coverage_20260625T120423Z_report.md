...
Generated UTC: 2026-06-25T12:04:31+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260625T120423Z`
...
| --- | ---: |
| `coverage rows for this run` | 72600 |
| `complete station-years` | 18775 |
| `partial station-years` | 51011 |
| `empty station-years` | 2814 |
| `valid DJF hours represented` | 65130112 |
