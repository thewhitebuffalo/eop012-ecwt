...
Generated UTC: 2026-06-24T07:19:44+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T071938Z`
...
| `publication candidates` | 75 |
| `provisional low coverage` | 16029 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 12280 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 3749 |
| `publication_candidate` | `passes_current_publication_gate` | 75 |
