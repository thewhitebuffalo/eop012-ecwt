...
Generated UTC: 2026-06-24T13:42:50+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T133641Z`
...
| --- | ---: |
| `coverage rows for this run` | 52005 |
| `complete station-years` | 10703 |
| `partial station-years` | 39594 |
| `empty station-years` | 1708 |
| `valid DJF hours represented` | 39102448 |
