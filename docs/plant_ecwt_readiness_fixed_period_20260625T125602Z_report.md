...
Generated UTC: 2026-06-25T12:56:04+00:00
...
- Calculation run ID: `plant_ecwt_readiness_fixed_period_20260625T125602Z`
...
| `publication candidates` | 1641 |
| `provisional low coverage` | 0 |
| `blocked` | 14491 |
| `minimum coverage ratio` | 0.9501 |
| `median coverage ratio` | 0.9606 |
