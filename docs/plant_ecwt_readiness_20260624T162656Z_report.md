...
Generated UTC: 2026-06-24T16:27:12+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T162656Z`
...
| `publication candidates` | 1655 |
| `provisional low coverage` | 14449 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 13138 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1311 |
| `publication_candidate` | `passes_current_publication_gate` | 1655 |
