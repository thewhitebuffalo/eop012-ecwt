...
Generated UTC: 2026-06-24T10:17:46+00:00
...
- Calculation run ID: `plant_ecwt_readiness_20260624T101745Z`
...
| `publication candidates` | 4585 |
| `provisional low coverage` | 11519 |
| `blocked` | 28 |
...
| `provisional_low_coverage` | `coverage_ratio_below_threshold` | 9841 |
| `provisional_low_coverage` | `valid_hours_below_threshold` | 1678 |
| `publication_candidate` | `passes_current_publication_gate` | 4585 |
