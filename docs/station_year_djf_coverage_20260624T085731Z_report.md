...
Generated UTC: 2026-06-24T09:01:33+00:00
...
- Calculation run ID: `station_year_djf_coverage_20260624T085731Z`
...
| --- | ---: |
| `coverage rows for this run` | 42519 |
| `complete station-years` | 7033 |
| `partial station-years` | 34537 |
| `empty station-years` | 949 |
| `valid DJF hours represented` | 27796268 |
| `rejected source rows represented` | 113179365 |
